...
def convert_shape():
    ...
    #save the file
    piezo2.to_file("../include/shapefiles/Aquitaine/Isopiezes_mio-plio-quaternaire_latlon.shp",encoding='utf-8')
...
def map_piezo():
    ...
    # Open shapefile
    map.readshapefile("../include/shapefiles/Aquitaine/Isopiezes_mio-plio-quaternaire_latlon",  "piezo", color = 'w')
