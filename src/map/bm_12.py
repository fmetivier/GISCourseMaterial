...
ds  =  gdal.Open("../../Data/map/raster/Aquitaine/LC82000292015341LGN00.jpg")
data  =  ds.ReadAsArray()
...
fig = plt.figure(figsize = (10, 10))# because it is a raster the output size is important
map = Basemap(projection = 'tmerc',  lon_0 = Long, lat_0 = Lat, width = w, height = h)

map.imshow(plt.imread("../../Data/map/raster/Aquitaine/LC82000292015341LGN00.jpg"),  origin = 'upper')
...
plt.savefig('../../figures/bm_12.svg',bbox_inches='tight')
plt.show()
