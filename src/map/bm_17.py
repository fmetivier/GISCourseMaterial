...
ax.streamplot(
    xx, yy, -u, -v, density=1, color="red", arrowsize=2.5
...
# Scale
map.drawmeridians(
    [-1.4, -1.2, -1, -0.8], color="r", dashes=[4, 2], labels=[0, 0, 0, 1], fontsize=12
)
map.drawparallels(
    [44.2, 44.4, 44.6], color="r", dashes=[4, 2], labels=[1, 0, 1, 0], fontsize=12
)


# Show
plt.savefig("../../figures/shp2grid.svg", bbox_inches="tight")
plt.show()
