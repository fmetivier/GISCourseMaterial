...
# ds  =  gdal.Open("../../Data/map/raster/Guadeloupe/ASTGTM2_N16W062/ASTGTM2_N16W062_dem.tif")
ds  =  gdal.Open('../../Data/map/raster/Guadeloupe/ASTGTM2_N15W062/ASTGTM2_N15W062_dem.tif')
data  =  ds.ReadAsArray()
...
# plt.savefig('../../figures/bm_12_2.svg',bbox_inches='tight')
plt.show()
