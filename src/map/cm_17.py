...
# open shapefile
deps = geopandas.read_file("../../Data/map/shapefiles/Aquitaine/Isopiezes_mio-plio-quaternaire_latlon.shp")
...
c = ax.contourf(xx, yy, zz, [10, 20, 30, 40, 50, 60, 70, 80], alpha = 0.4, transform=plot_CRS)
ax.contour(xx, yy, zz, [10, 20, 30, 40, 50, 60, 70, 80], transform=plot_CRS)
ax.streamplot(xx, yy, -u, -v, density = 1, color = 'red', arrowsize = 2.5, transform=plot_CRS) # streamlines $\mathbf{U}_{Darcy} \propto - \mathbf{grad}(h)$
