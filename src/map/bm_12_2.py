...
def merge_dems():
    ...
    gm.main(['', '-n', '0', '-o', '../../Data/map/raster/Guadeloupe/antilles.tif', \
    '../../Data/map/raster/Guadeloupe/ASTGTM2_N16W062/ASTGTM2_N16W062_dem.tif', \
    '../../Data/map/raster/Guadeloupe/ASTGTM2_N15W062/ASTGTM2_N15W062_dem.tif'])

    gdal.Warp("../../Data/map/raster/Guadeloupe/guadeloupe.tif", "../../Data/map/raster/Guadeloupe/antilles.tif", outputBounds = (-62, 15.7, -61, 16.7))
...
ds  =  gdal.Open("../../Data/map/raster/Guadeloupe/guadeloupe.tif")
data  =  ds.ReadAsArray()
...
# plt.savefig("../../figures/guadeloupe.svg", bbox_inches = "tight")
plt.show()
